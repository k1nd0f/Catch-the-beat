...
public class User {
    ...
    public void initIcon() {
        Texture texture = new Texture(Gdx.files.local(Globals.LOCAL_PATH_TO_USERS_DIRECTORY + uid + "/icon"));
        texture.setFilter(Texture.TextureFilter.Linear, Texture.TextureFilter.Linear);
        Globals.BEATMAP_SELECTION_MENU_SCREEN.getSideBar().initCurrentUserIcon(new Image(texture));
        Globals.STATISTIC_SCREEN.initUserIcon(new Image(texture));
    }

    public void initDefaultIcon() {
        Globals.BEATMAP_SELECTION_MENU_SCREEN.getSideBar().initCurrentUserIcon(new Image(UI.SKIN_ATLAS.findRegion(UI.USER_DEFAULT_ICON)));
        Globals.STATISTIC_SCREEN.initUserIcon(new Image(UI.SKIN_ATLAS.findRegion(UI.USER_DEFAULT_ICON)));
    }
    ...
    public void addToFriendsList(String uid) {
        ...
        Long chatId = database.createNewChat().getId();
    ...
    public Long getChatId(String friendUid) {
